          ...
          <div className="flex flex-row justify-center w-full mx-auto max-w-[1324px]">
            <div className="flex flex-row justify-between items-center w-full">
              ...
              <div className="flex flex-row justify-start items-center w-[69%] gap-[45px]">
                <div className="flex flex-row justify-start items-center w-[82%] pl-[355px] gap-8">
                  <Text />
                  <Heading size="s" as="h6" className="flex justify-center items-center w-[79px] h-[60px] py-[15px] px-5px tracking-[-1.16px] bg-white-A700">Crypto Tax</Heading>
          ...
          <div className="flex flex-col items-start justify-start w-full gap-[17px] max-w-[1328px]">
            ...
            <div className="flex flex-col items-center justify-start w-full pb-[22px]">
              <div className="flex flex-col items-start justify-start w-full">
                <div className="flex flex-row justify-start items-start w-full gap-5">
                      ...
                      <div className="flex flex-row justify-start items-center w-full gap-9">
                        ...
                        <div className="flex flex-row justify-start w-[10%]">
                          <Button
                            ...
                            size="lg"
                            className="w-auto font-medium border-blue_gray-400 border border-solid"
                          >
                            Rank #1
                          </Button>
                        </div>
                    ...
                    <div className="flex flex-row justify-center w-full">
                      <div className="h-[70px] w-full relative">
                        ...
                        <div className="flex flex-row justify-center w-max h-full gap-8 left-0 bottom-0 right-0 top-0 m-auto absolute">
                          ...
                          <div className="flex flex-row justify-start w-[18%] py-[23px]">
                  ...
                  <div className="flex flex-col items-center justify-start w-[33%] gap-5">
                    <div className="flex flex-col items-center justify-start w-full gap-[19px] p-[31px] bg-blue-A700_01 rounded-[16px]">
                      ...
                      <Img src="images/img_frame.svg" alt="image_two" className="h-[266px]" />
                      <Button
                        color="white_A700"
                        size="xl"
                        rightIcon={
                        ...
                        className="mb-[28px] gap-2.5 font-semibold min-w-[237px]"
                      >
                ...
                <div className="h-[632px] w-[69%] mt-[19px] relative">
      <div className="justify-center h-[632px] w-[97%] left-0 bottom-0 right-0 top-0 m-auto bg-white-A700 absolute rounded-lg">
        <div className="flex flex-row justify-start w-full left-4 top-[3%] m-auto absolute">
          <h4 className="text-xl font-bold relative">Performance</h4>
        </div>
        <div className="flex flex-col items-start justify-center w-max h-max left-4  right-0 top-0 m-auto absolute">
          <div className="flex flex-row justify-start w-full">
            <div className="flex flex-row justify-start w-full">
                ...
                <div className="flex flex-row justify-center w-full">
                  <div className="flex flex-row justify-center items-center w-full">
                    <div className="flex flex-col items-center justify-start w-[14%] pb-[13px] gap-2.5">
                      <div className="flex flex-row justify-start w-full left-4 ">
                        <Text
                          size="md"
                          as="p"
                          className="mt-12 !text-blue_gray-800_02 !text-[13.78px] !font-normal"
                        >
                          Today’s Low
                        </Text>
                      </div>
                      <div className="flex flex-row justify-start w-full pt-[13px] pb-[460px]">
                    ...
                    <div className="flex flex-row justify-center w-[73%]">
                      <div className="flex flex-col items-end justify-start w-full relative pb-[427px] right-16">
                        <Img
                          src="images/img_div_pbar29range.png"
                          alt="divpbar29range"
                          className="w-full max-w-full rounded-lg shadow-lg left-4"
                    ...
                    <div className="flex flex-col items-center justify-start w-[14%] left-4 pb-[13px] gap-2">
                      <div className="flex flex-row justify-start w-full">
                        <Text
                          size="md"
                          as="p"
                          className="mt-2 !text-blue_gray-800_02 text-left !text-[13.56px] !font-normal"
                        >
                          Today’s High
                        </Text>
                      </div>
                      <div className="flex flex-row justify-end w-full pt-[3px] pb-[460px]  gap-2">
              ...
              <div className="flex flex-row justify-center items-center w-full">
                ...
                <Img
                  ...
                  style={{ maxWidth: '300px', maxHeight: '300px', objectFit: 'cover', marginLeft: '100078px' }}
                />
                <div className="flex flex-col items-center justify-start w-[14%] pb-[13px] gap-2.5">
                  ...
                  <div className="flex flex-row justify-end w-full pt-[3px]">
                    ...
                    <div className="flex flex-row justify-start items-center w-[64%] mt-[122px] gap-px">
                      <div className="flex flex-row justify-start w-[27%]">
                        <Heading size="md" as="h6" className="!text-blue_gray-800_02 !text-[18.91px]">
                          Fundamentals
                        </Heading>
                      </div>
                      <Img src="images/img_svg_margin.svg" alt="svgmargin_one" className="h-[10px]" />
                    </div>
                      ...
                      <div className="flex flex-col items-center justify-start w-[42%] pt-[18px]">
                        ...
                        <div className="flex flex-col items-center justify-start w-full pt-[18px]">
                          ...
                          <div className="flex flex-row justify-between items-center w-full pr-3 py-3 border-blue_gray-100 border-b border-solid">
                            ...
                            <Text size="md" as="p" className="h-[16px] !text-gray-900_03 text-left">
                              #1
                            </Text>
                          </div>
                        </div>
                  ...
                  <div className="justify-center h-[556px] w-[97%] left-0 bottom-0 right-0 top-0 m-auto absolute">
                    ...
                    <div className="flex flex-col items-center justify-start w-[78%] gap-[33px] bottom-[5%] left-[3%] m-auto absolute">
                      <div className="flex flex-col items-start justify-start w-full gap-3.5">
                        ...
                        <div className="flex flex-col w-[55%] gap-px">
                    ...
                    <div className="flex flex-row justify-start w-full left-8 top-[6%] m-auto absolute">
                      <Heading as="h">Sentiment</Heading>
                    </div>
                  </div>
                  <div className="flex flex-row justify-center w-[48%] right-0 top-[19%] px-[7px] m-auto border-blue-50 border border-solid bg-blue_gray-50 absolute rounded-[12px]">
                    <div className="flex flex-row justify-start items-start w-full mb-[1px] gap-2">
                      <Img
                        src="images/img_frame_1116601921.svg"
                        alt="circleimage"
                        className="h-[44px] w-[44px] mt-px rounded-[50%]"
                      />
                      <div className="flex flex-col items-center justify-start w-[55%] gap-1">
                        <div className="flex flex-row justify-center w-full">
                          <div className="flex flex-row justify-start w-full">
                            <Text as="p" className="w-[95%] !text-gray-900_04 !font-sfprotext leading-5">
                ...
                <div className="h-[1012px] w-[69%] mt-5 relative">
                  <div className="justify-center h-[995px] w-full left-0 bottom-0 right-0 top-0 m-auto absolute">
                    <div className="justify-center h-[995px] w-[97%] left-2 bottom-0 right-0 top-0 m-auto bg-white-A700 absolute rounded-lg" />
                    <div className="flex flex-col items-center justify-start w-[91%] gap-[15px] top-[8%] right-0 left-4 m-auto absolute">
                      <div className="flex flex-col items-start justify-start w-full">
                    ...
                    <div className="flex flex-row justify-start w-full left-10 top-[2%] m-auto relative">
                      <Heading as="h4">About Bitcoin</Heading>
                    </div>
                  </div>
                  <div className="flex flex-row justify-center w-[91%] bottom-20 right-0 left-0 m-auto absolute pb-133">
                ...
                <div className="h-[539px] w-[69%] mt-[3px] relative">
                  ...
                  <div className="flex flex-row justify-start w-full right-0 left-10 top-[4%] m-auto absolute">
                    <Heading as="h4">Tokenomics</Heading>
                  </div>
                  <div className="flex flex-col items-center justify-center w-full h-full left-8 bottom-0 right-0 top-0 m-auto relative">
                ...
                <div className="h-[776px] w-[69%] mt-5 relative">
                  <div className="justify-center h-[776px] w-[97%] left-19 bottom-0 right-10 top-0 m-auto bg-white-A700 absolute rounded-lg" />
                  <div className="flex flex-row justify-start w-full left-8 top-[3%] m-auto absolute">
                    <Heading as="h4">Team</Heading>
                  </div>
                  <div className="flex flex-col items-center justify-center w-full h-full gap-6 left-0 bottom-0 right-0 top-20 m-auto absolute">
                    <div className="flex flex-row justify-center w-full">
                      <div className="flex flex-row justify-center w-full">
                        <Text size="2xl" as="p" className="!text-gray-800 !leading-[160%]">
